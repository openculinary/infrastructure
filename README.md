...
wget -qO - https://download.opensuse.org/repositories/devel:/kubic:/libcontainers:/stable:/cri-o:/1.28/Debian_11/Release.key | sudo apt-key add -
...
echo 'deb https://download.opensuse.org/repositories/devel:/kubic:/libcontainers:/stable:/cri-o:/1.28/Debian_11/ /' | tee /etc/apt/sources.list.d/devel:kubic:libcontainers:stable.list
